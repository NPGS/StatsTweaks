...
-- BERSERK
	...
	-- Berserk BioDyne Mk.4
	TweakDB:SetFlat("Items.BerserkC2MK4_inline4.value", 20)	-- armor / resistances
	TweakDB:SetFlat("Items.BerserkC2MK4_inline6.value", 30)	-- cooldown

	-- Berserk Zetatech Mk.4
	TweakDB:SetFlat("Items.BerserkC3MK4_inline4.value", 20)	-- armor / resistances
	TweakDB:SetFlat("Items.BerserkC3MK4_inline5.value", 30)	-- duration
	TweakDB:SetFlat("Items.BerserkC3MK4_inline6.value", 30)	-- cooldown

	-- Berserk Zetatech Mk.5
	...
	TweakDB:SetFlat("Items.BerserkC3MK5_inline4.value", 30)	-- armor / resistances
	...
	TweakDB:SetFlat("Items.BerserkC4MK5_inline4.value", 30)	-- armor / resistances
